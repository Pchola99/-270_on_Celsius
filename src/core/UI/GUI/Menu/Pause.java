...
public class Pause {
    ...
    public static void create() {
        if (!created) {
            ...
            createButton(840, 600, 240, 65, getName("Continue"), null, false, new Color(255, 80, 0, 55), "Pause");
            createButton(840, 400, 240, 65, getName("Exit"), null, false, new Color(236, 236, 236, 55), "Pause");
