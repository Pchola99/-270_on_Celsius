...
public class Main {
    public static void create() {
        ...
        createButton(822, 990, 240, 65, getName("Exit"), null, false, new Color(236, 236, 236, 55));
        createButton(548, 990, 240, 65, getName("Settings"), null, false, new Color(236, 236, 236, 55));
        createButton(46, 990, 240, 65, getName("Play"), null, false, new Color(255, 80, 0, 55));
    }
