...
public class ToggleButton extends BaseButton<ToggleButton> {
    ...
    public void draw() {
        ...
        if (simple && isClicked) {
            ...
            batch.draw(atlas.byPath("UI/GUI/checkMarkTrue.png"), x + width / 1.3f, y + height / 3f);
            ...
            if (isClicked) {
                ...
                batch.draw(atlas.byPath("UI/GUI/checkMarkTrue.png"), x, y);
                drawText(width + x + 24, y, name);
            } else {
                Fill.rectangleBorder(x - 6, y - 6, width, height, 6, color);
                batch.draw(atlas.byPath("UI/GUI/checkMarkFalse.png"), x, y);
                drawText(width + x + 24, y, name);
            }
        }
        drawPrompt(this);
