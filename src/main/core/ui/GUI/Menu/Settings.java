...
public class Settings extends Dialog {
    ...
    public Settings() {
        addPanel(20, 20, 1880, 1040);
        addPanel(40, 40, 240, 1000)
                .setSimple(true);
        ...
        addButton(this::otherBtn)
                .set(40, 100, 240, 65)
                .setName(getName("SettingsOther"))
                .setSimple(true)
                .setColor(SimpleColor.DIRTY_BLACK);
        save = addButton(this::saveBtn)
                .set(40, 800, 240, 65)
                .setName(getName("SettingsSave"))
                .setSimple(true)
                .setColor(SimpleColor.DEFAULT_ORANGE);
        addButton(this::graphicsBtn)
                .set(40, 300, 240, 65)
                .setName(getName("SettingsGraphics"))
                .setSimple(true)
                .setColor(SimpleColor.DIRTY_BLACK);
        graphicsSettings = add(new Dialog() {{
            visible = true;
            addToggleButton(() -> {
